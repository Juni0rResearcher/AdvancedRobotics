...
Данный проект представляет собой решение домашнего задания по обнаружению стен (прямых линий) на синтетических данных, имитирующих 2D-Лидар, с использованием преобразования Хафа. Также в проекте реализован алгоритм RANSAC для обнаружения плоскости пола в облаке точек.
...
*   **Redwood Living Room dataset :** скан комнаты.
...
*   Визуализация синтетического облака точек с выделенной плоскостью пола, найденной с помощью RANSAC. Красными точками выделен пол, синими - препятствия (в данном случае все не горизонтальные поверхности)
